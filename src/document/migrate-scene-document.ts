...
import {
  ...
  PATH_ROAD_PREVIEW_SCENE_DOCUMENT_VERSION,
  ...
  NPC_TARGET_ANCHOR_SCENE_DOCUMENT_VERSION,
...
export function migrateSceneDocument(source: unknown): SceneDocument {
  ...
  if (
    ...
    source.version !== FOLIAGE_FOUNDATION_SCENE_DOCUMENT_VERSION &&
    source.version !== FOLIAGE_MASKS_SCENE_DOCUMENT_VERSION &&
    source.version !== FOLIAGE_QUALITY_SCENE_DOCUMENT_VERSION &&
    source.version !== FOLIAGE_BLOCKER_MASKS_SCENE_DOCUMENT_VERSION &&
    source.version !== SCENE_DOCUMENT_VERSION &&
