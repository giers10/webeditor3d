...
const TERRAIN_GRID_RESIZE_ARROW_MIN_LENGTH = 0.8;
const TERRAIN_GRID_RESIZE_ARROW_MAX_LENGTH = 2.4;
const TERRAIN_GRID_RESIZE_ARROW_CELL_FACTOR = 1.25;
const TERRAIN_GRID_RESIZE_ARROW_HEAD_LENGTH = 0.32;
