...
const TERRAIN_GRID_RESIZE_EDGE_COLOR = 0xffd84d;
const TERRAIN_GRID_RESIZE_ARROW_COLOR = 0xffffff;
const TERRAIN_GRID_RESIZE_OUTLINE_COLOR = 0x05070c;
const TERRAIN_GRID_RESIZE_OVERLAY_OFFSET = 0.12;
const TERRAIN_GRID_RESIZE_EDGE_SEGMENTS = 32;
const TERRAIN_GRID_RESIZE_EDGE_TUBE_RADIUS = 0.07;
const TERRAIN_GRID_RESIZE_EDGE_OUTLINE_RADIUS = 0.115;
...
const TERRAIN_GRID_RESIZE_ARROW_MIN_LENGTH = 1.25;
const TERRAIN_GRID_RESIZE_ARROW_MAX_LENGTH = 3.6;
const TERRAIN_GRID_RESIZE_ARROW_CELL_FACTOR = 1.8;
const TERRAIN_GRID_RESIZE_ARROW_SHAFT_RADIUS = 0.065;
const TERRAIN_GRID_RESIZE_ARROW_SHAFT_OUTLINE_RADIUS = 0.11;
const TERRAIN_GRID_RESIZE_ARROW_HEAD_RADIUS = 0.24;
const TERRAIN_GRID_RESIZE_ARROW_HEAD_OUTLINE_RADIUS = 0.34;
const TERRAIN_GRID_RESIZE_ARROW_HEAD_LENGTH = 0.55;
const TERRAIN_GRID_RESIZE_ARROW_HEAD_OUTLINE_LENGTH = 0.68;
